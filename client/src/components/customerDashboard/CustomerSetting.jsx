...
const CustomerSetting = () => {
  ...
  // NNNEEEWWW: password modal ke liye naya state add kiya
  ...
  return (
    ...
    <>
        ...
        <div className="w-full max-w-xl bg-white rounded-2xl shadow-lg p-6 md:p-8">
          <div className="flex justify-between items-center mb-6">
            ...
            {!editingProfile ? (
              ...
              <div className="flex gap-2">
                {/* FIXED: rounded-br-2xl -> rounded-lg, taaki baaki buttons se consistent ho */}
                <button
      ...
      {/* NNNEEEWWW: PasswordChangeModal render karne wala poora block add kiya */}
