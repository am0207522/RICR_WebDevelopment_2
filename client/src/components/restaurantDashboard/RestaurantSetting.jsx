...
//                   className="flex items-center gap-2 bg-[#c2410c] text-white px-3 py-1 rounded text-sm"
//                 >
//                   <MdEdit /> Edit
//                 </button>
//                 <button
//                   onClick={() => setIsPasswordChangeModalOpen(true)}
//                   className="flex items-center gap-2 border border-[#c2410c] text-[#c2410c] px-3 py-1 rounded text-sm hover:bg-[#c2410c] hover:text-white"
//                 >
...
//                   className="flex items-center gap-2 bg-[#6b7280] text-white px-3 py-1 rounded text-sm"
//                   disabled={isLoading}
//                 >
//                   Cancel
//                 </button>
...
//                     alt="Profile"
//                     className="w-full h-full rounded-full object-cover border-2 border-[#c2410c]"
//                   />
//                 </div>

//                 {editingProfile && (
//                   <div
//                     className="absolute cursor-pointer bottom-1 right-1 border p-2 rounded-full w-fit bg-[#f5ede5]"
//                     title="Change Photo"
//                   >
...
//                       className={`w-full px-1.5 py-1 border border-[#6b7280] ${editingProfile ? "bg-[#fff8f1]" : "bg-[#f5ede5]"} rounded`}
...
//                       onChange={handleProfileChange}
//                       className={`w-full px-1.5 py-1 border border-[#6b7280] disabled:bg-[#6b7280] cursor-not-allowed  rounded`}
//                       disabled
//                     />
//                   </div>
...
//             <span className="text-lg text-[#c2410c] font-semibold mt-2 animate-bounce">
//               Fetching Restaurant Information
//             </span>
//           </div>
//         ) : loadingRestaurantError ? (
//           <div className="flex flex-col justify-center items-center h-64">
//             <span className="text-lg text-[#ef4444] font-semibold mt-2">
//               {loadingRestaurantError}
//             </span>
//           </div>
//         ) : (
//           <div className="bg-[#f5ede5] rounded-lg p-3">
//             <div className="flex justify-between items-center border-b border-[#6b7280] pb-2 mb-2">
//               <div className="flex items-center gap-3">
...
//                   onChange={handleRestaurantChange}
//                   className={`w-full px-1.5 py-1 border border-[#6b7280] ${editingRestaurant ? "bg-[#fff8f1]" : "bg-[#f5ede5]"} rounded`}
//                   disabled={!editingRestaurant}
//                 />
//               </div>
//               <div className="w-full">
...
//                   onChange={handleRestaurantChange}
//                   rows={3}
//                   className={`w-full px-1.5 py-1 border border-[#6b7280] ${editingRestaurant ? "bg-[#fff8f1]" : "bg-[#f5ede5]"} rounded resize-none`}
//                   disabled={!editingRestaurant}
//                 />
//               </div>
...
//                     className="text-xs bg-[#c2410c] text-white px-2 py-0.5 rounded"
//                   >
//                     + Add Link
//                   </button>
//                 )}
...
//                         )
//                       }
//                       className={`w-full px-1.5 py-1 border border-[#6b7280] ${editingRestaurant ? "bg-[#fff8f1]" : "bg-[#f5ede5]"} rounded text-sm`}
//                       disabled={!editingRestaurant}
//                     />
