...
const ResturantCoreDetails = () => {
  ...
  const handleSaveRestaurant = async () => {
    try {
      ...
      // the real backend endpoint (POST /restaurant/update-profile). Only the
      // fields this screen actually edits are sent (address/geo/social links),
      // so it won't overwrite data owned by the Information tab.
      const payload = {
        ...
        socialMediaLinks: restaurantFormData.socialMediaLinks,
      };
      ...
      toast.success(
        res.data.message || "Restaurant details updated successfully",
      );
    } catch (error) {
      toast.error(
