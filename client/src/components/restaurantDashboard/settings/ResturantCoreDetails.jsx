    ...
    try {
      ...
      const payload = {
        ...
        documents: {
          ...
          gstCertificate: restaurantFormData.gstCertificate,
          fssaiCertificate: restaurantFormData.fssaiCertificate,
          ...
          <>
            <div className="flex flex-col gap-2 h-full">
              ...
              <div className="bg-(--color-base-100) rounded-lg p-3">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-2 justify-center items-center">
                  ...
                  <div className="w-full">
                    ...
                    {/* FIXED: was bound to restaurantFormData?.state */}
                    <input
                      type="text"
                      name="ifscCode"
                  ...
                  <div className="w-full">
                    ...
                    <input
                      type="text"
                      name="gstCertificate"
                      value={restaurantFormData?.gstCertificate || ""}
                      onChange={handleRestaurantChange}
                      className={`w-full px-1.5 py-1 border border-(--color-secondary) ${editingRestaurant ? "bg-white" : "bg-(--color-base-100)"} rounded`}
                      disabled={!editingRestaurant}
                    />
                  ...
                  <div className="w-full">
                    ...
                    <input
                      ...
                      value={restaurantFormData?.fssaiCertificate || ""}
                      onChange={handleRestaurantChange}
                      className={`w-full px-1.5 py-1 border border-(--color-secondary) ${editingRestaurant ? "bg-white" : "bg-(--color-base-100)"} rounded`}
                      disabled={!editingRestaurant}
                    />
              ...
              <div className="bg-(--color-base-100) rounded-lg p-3 h-full flex flex-col">
                ...
                <div className="flex flex-col gap-2 h-16 overflow-y-auto">
